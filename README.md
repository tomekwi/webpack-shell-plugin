...
### API
* `beforeBuildStart`: array of scripts to execute before the initial build starts. **Default: [ ]**
* `onBuildStart`: array of scripts to execute in parallel to the initial build. **Default: [ ]**
